...
<div class="container">
    ...
    <form:form method="post" modelAttribute="task" action="/tasks/added">
    ...
    <%--<table>--%>
        <%--<form:form method="post" modelAttribute="task" action="/tasks/added">--%>
            <%--<tr>--%>
                ...
                <%--<form:errors path="subject" cssStyle="color: red" element="td"/>--%>
            <%--</tr>--%>
            <%--<tr>--%>
                <%--<td>description:</td>--%>
            ...
            <%--&lt;%&ndash;<input type="hidden" path="project_id" value="${id}">&ndash;%&gt;--%>
            <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<td>status:</td>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<td><form:input path="status" /></td>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<form:errors path="status" cssStyle="color: red" element="td"/>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>
